...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form id='formu' action="{{ route('store') }}" method="post" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <div class='gap-3 p-3'><label class='form-label pe-5'>Wybierz ocenę:</label>
       ...
       <div class='col-mb-3'><label for='textarea' class='form-label'>Recenzja:</label><textarea class='form-control' name="message" id='message' rows='7' required></textarea></div>
