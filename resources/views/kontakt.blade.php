...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class='card-header'>Kontakt do nas!</div>
        <div class='card-body'><img class='card-img-top' src='zdjęcia/fallout.png' alt='...' /></div>
        </div>
        <section class='mb-5'>
        <h2 class='card-title'>Dane autora strony:</h2>
            <p class='fs-5 mb-4'>Imię i nazwisko: Hubert Orzechowski</p>
            <p class='fs-5 mb-4'>Adres email: hubert.orzechowski@edu.pl</p>
            <p class='fs-5 mb-4'>Uczelnia: Politechnika Lubelska</p>
            <p class='fs-5 mb-4'>Adres: Nadbystrzycka 38A, 20-618 Lublin</p>
        <h2 class='card-title'>Żródła:</h2>
            <p class='fs-5 mb-4'>Recenzje filmów: <a href='https://www.filmweb.pl/'>FilmWeb</a></p>
            <p class='fs-5 mb-4'>Zdjęcia:
            <ul><li> <a href='https://pixabay.com/pl/'>Pixabay</a></li>
            <li> <a href='https://www.pexels.com/pl-pl/'>Pexels</a></li>
            </ul></p>
        </section>
            </div>
        </div>
