        ...
        <div class="container">
            <div class="row">
                ...
                <div id="zamiana" class="col-lg-8">
                    <!-- Featured blog post-->
                @if($reviews->isEmpty())
                <h4><br />Nikt jeszcze nie napisał recenzji tego filmu. Możesz być pierwszy!</h4>
                @else
                    ...
                    @php
                    $help=$review->id;
                    $comments = App\Models\Comment::whereHas('user', function ($query) use($help) { $query->where('post_id', 'like', '%'.$help.'%');})->get()
                    @endphp
                    ...
                    @if($comments->isNotEmpty())
                        ...
                        <div class="card mb-4">
                                        <div class="row">
                                            ...
                                            <div class='card-body'>
                                            <div class='small text-muted'>Odpowiedź na recenzje użytkownika: {{$review->user->name}} na temat: {{$review->title}}</div>
